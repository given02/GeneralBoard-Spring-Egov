...
public class EgovImgPaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	*/
	public void initVariables() {
		...
		firstPageLabel = "<a href=\"javascript:void(0);\" onclick=\"{0}({1}); return false;\" class=\"prev end\">처음으로</a>";
		...
		lastPageLabel = "<a href=\"javascript:void(0);\" onclick=\"{0}({1}); return false;\" class=\"next end\">마지막으로</a>";
